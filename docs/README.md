...
* [Languages](#languages)
    ...
    * [cli](#cli-5)
    * [cliInit](#cliinit-5)
    * [getLanguageFromUrlPath](#getlanguagefromurlpath)
...
### getLanguageFromUrlPath

Get current language from URL path
f.e. https://novembit.com/fr/my/post/path

```php
Languages::getLanguageFromUrlPath( string $url ): string
```
...
```php
Languages::getLanguageFromUrl( string $url ): string|null
```
...
```php
Languages::getScriptUrl(  ): mixed|string|null
```
