 ...
 * @link     https://github.com/NovemBit/i18n
 * */
class UrlTranslator extends TypeAbstract implements interfaces\URL
{
    /**
     * {@inheritdoc}
     * */
     ...
     * */
    public string|\NovemBit\i18n\component\translation\models\TranslationDataMapper $model_class = models\URL::class;
     ...
     * To exclude path special parts
     * After translate your excluded paths will be restored
     *
     * @example `\/var\/.*`
     * */
    ...
    {
        foreach ($translations as &$language_translations) {
            foreach ($language_translations as &$translation) {
                $this->validateBeforeTranslate($translation);
            }
        }
        unset($translation, $language_translations);

        parent::saveModels($translations, $from_language, $level, $overwrite, $result); // TODO: Change the autogenerated stub
    }
    ...
    protected function prepareUrlToProcess(string &$url): bool
    {
        ...
        $url = $this->localization->removeScriptNameFromUrl($url);
     ...
     *
     * @param  string  $text  Translatable url
     *
     * @return bool
     */
    protected function validateBeforeTranslate(string &$text): bool
    {
        return $this->prepareUrlToProcess($text);
    }
     ...
     */
    private function getPathPartTranslations(
        array $paths,
        string $from_language,
        array $to_languages,
        bool $ignore_cache
    ...
    protected function validateBeforeReTranslate(&$url): bool
    {
        ...
        if(!$this->save_translations){
            $url = $this->localization->removeLanguageFromURI($url);
        }
        return $status;
    }
