...
class URL extends Type implements interfaces\URL
{
     ...
     * */
    public string|\NovemBit\i18n\component\translation\models\Translation $model_class = models\URL::class;
    ...
    public function saveModels($translations, $level = 0, $overwrite = false, &$result = []): void
    {
        ...
        parent::saveModels($translations, $level, $overwrite, $result); // TODO: Change the autogenerated stub
    }

    /**
     * Doing translation method
     *
     * @param  string[]  $nodes  list of urls
     ...
     * @throws InvalidArgumentException
     */
    private function getPathPartTranslations(array $paths, bool $ignore_cache): array
    {
